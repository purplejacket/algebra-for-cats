...
scene("main", (levelInx) => {
  ...
  const npc = {
    ...
    "ç": {
      sprite: "npc4",
      msg: "huh, you could go through all the levels, honestly i thought you would die, it seems like i did underestimate you",
      name: "keeper",
      textsize: 8,
    },
    "©": {
      sprite: "npc4",
      msg: "congratulations kid, now, the big deal is in front of this door",
      name: "keeper",
      textsize: 9,
    },
  };
